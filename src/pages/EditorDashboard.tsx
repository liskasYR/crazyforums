...
export default function FormEditor() {
    ...
    if (authLoading || loading || !form) return (
        ...
        <div className="min-h-screen text-white bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 animate-background p-6">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-6">
                    <Button variant="outline" onClick={() => navigate("/editor")} className="bg-black text-white hover:bg-gray-800" >
                        <ArrowLeft className="w-4 h-4 ml-2" />
                        חזרה
                    </Button>
                    <div className="flex gap-2">
                        <Button variant="outline" onClick={copyFormLink} className="bg-black text-white hover:bg-gray-800" >
                            <Copy className="w-4 h-4 ml-2" />
                            העתק קישור
                        </Button>
                        <Button onClick={saveForm} disabled={saving} className="bg-black text-white hover:bg-gray-800" >
                    ...
                    <TabsContent value="design">
                        <CustomizationPanel
                            ...
                            onStyleChange={(newStyle) =>
                                setForm({ ...form, style: { ...form.style, ...newStyle } })
                            }
                        />
                    </TabsContent>
                </Tabs>
